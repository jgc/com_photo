...
class PhotoTablephoto extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__photo', 'id', $db);
    }
...
echo JError::raiseNotice(100,$notice);
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_photo.photo.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_photo','photo');
            $default_actions = JFactory::getACL()->getAssetRules('com_photo.photo.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_photo.photo.' . (int) $this->$k;
    }
    ...
    */
    protected function _getAssetParentId($table = null, $id = null){
        ...
        $assetParent->loadByName('com_photo');
